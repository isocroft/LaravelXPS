                 ...
                 var Service = (function(){
                  ...
                  df("executionEnvironment", function(a){
										...
										var needles = (query || "").split(''), allMatch = !!options.allMatch, tip = (options.tip || ""), chunks;
									        ...
									        chunks = ([].concat.apply([], needles.map(function(needle){
									                return items.filter(function(haystack){
											            needle = (typeof needle != "string" ? needle[options.tip] : needle.toLowerCase());
													    haystack = haystack.toLowerCase();
													    var l;
                   ...
                   df("performance", function(r) {
                            ...
                            var h, g = r("executionEnvironment");
								
                            if (g.canUseDOM)
                                  h = w.performance || w.msPerformance || w.webkitPerformance;
               
                                return h || {
						                navigation:{type:"_request"},
										timing:{"loadEventEnd":0,"responseEnd":0,"fetchStart":0},
										now:function(){ 
